...
import THIRD
from THIRD.lib.curve.ttypes import *
...
wait = {
    ...
    "Timeline":True,
    'autoAdd':True,
    "comment1":"Bot Auto Like ©By : THIRD",
    "comment2":"Bot Auto Like ©By : THIRD ＼（○＾ω＾○）／",
    "comment3":"Bot Auto Like ©By : THIRDヘ(^_^)ヘ",
    "comment4":"Bot Auto Like ©By : THIRD (^_^)",
    "comment5":"Bot Auto Like ©By : THIRD",    
    "commentOn":True,
    "commentBlack":{},
